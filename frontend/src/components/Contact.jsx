                ...
                <div className="d-flex flex-column gap-4 text-primary">
                  ...
                  <div className="d-flex align-items-center gap-3">
                    ...
                    <div>
                      ...
                      <a href="https://www.linkedin.com/in/muhammed-ajmal-807114325" target="_blank" rel="noreferrer" className="text-primary text-decoration-none" style={{ position: 'relative', zIndex: 1 }}>LinkedIn Profile</a>
                    </div>
                  </div>
                </div>
              </div>
